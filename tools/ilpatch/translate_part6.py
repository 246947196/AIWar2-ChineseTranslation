...
tr = {
    ...
    " ship(s) that are stationary but thought they should be in pursuit mode.": " 艘处于静止状态但被认为是追击模式的舰船。",
    ...
    " player ship(s) that are in the loose fleet (bad).  Was able to correct ": " 艘玩家舰船处于松散舰队（异常）。已成功修正 ",
    " of those.": " 艘。",
    "  shipsNotFixedNonPlanetary: ": "  未修正的非行星舰船：",
    "  shipsNotFixedBroken: ": "  未修正的损坏舰船：",
    "  shipsNotFixedPlanetFactionIsNotPlanetaryCommand: ": "  未修正的星球阵营非行星指挥部舰船：",
    "  shipsNotFixedByType: ": "  未修正的按类型划分舰船：",
    "clear deprecated transported ships ": "清理已弃用的运输舰船：",
    ...
    "Ship: Fixed likely runaway loop in Client_AcceptFastBlastDataOfCreatedObjects.": "舰船：修复了 Client_AcceptFastBlastDataOfCreatedObjects 中可能的失控循环。",
