                ...
                foreach ( GameEntity_Squad debris in BaseInfo.SpireDebris.DisplaySquads() )
                {
                    ...
                    if ( World_AIW2.Instance.GameSecond >= debrisData.TimeUntilDebrisVanishes )
                    {
                        ...
                        else
                        {
                            ...
                            workingBuffer.Add( "" ).Add( factionToUse.GetDisplayName(), factionToUse.FactionCenterColor.ColorHexBrighter ).Add( "已获取" + debris.GetPlanetName_Safe() + "上的尖塔残骸。他们将修复此残骸以建造一个强大的单位来对抗敌人。" );
