...
{
    public class TemplarFactionBaseInfo : ExternalFactionBaseInfoRoot, IExternalBaseInfo_Singleton
    {
        //Serialized
        ...
        public readonly Dictionary<Planet, int> LastTimePlanetWasOwned = Dictionary<Planet, int>.Create_WillNeverBeGCed( 500, "TemplarFactionBaseInfo-LastTimePlanetWasOwned" );
        ...
        //Not Serialized
        int Intensity = 0;
        public static TemplarFactionBaseInfo Instance; //there can only ever be one of this faction at a time
        ...
        {
            Buffer.WriteHeaderStringToLogIfLoggingActive( "TemplarFactionBaseInfo" );
        ...
        {
            Buffer.WriteHeaderStringToLogIfLoggingActive( "TemplarFactionBaseInfo" );
            Buffer.ActivateOrAddTrackerByNameIfTracking( "TemplarFactionBaseInfo Ext", TrackerStyle.ByTypeOnly );
        ...
        public void GetTemplarStateForDisplay( ArcenDoubleCharacterBuffer buffer )
        {
            ...
            buffer.Add( "\n" );
            buffer.Add( "Time till next assault wave: " ).Add( (this.TimeForNextAssaultWave - World_AIW2.Instance.GameSecond), "a1ffa1" ).Add( " with " ).Add( this.WaveLeadersToSpawn, "ffa1a1" ).Add( " leaders.\n" );
        }
        #endregion
        ...
        public override void DoPerSecondLogic_Stage2Aggregating_OnMainThreadAndPartOfSim_ClientAndHost( ArcenClientOrHostSimContextCore Context )
        {
            ...
            try
            {
                ...
                foreach ( GameEntity_Squad entity in AttachedFaction.Squads() )
                {
                    ...
                    if ( !tracing )
                        continue; //we don't need to count the total units except for tracing
