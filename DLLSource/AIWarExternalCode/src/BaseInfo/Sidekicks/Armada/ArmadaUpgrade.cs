        ...
        public override void AddDescription(ArcenCharacterBufferBase buffer)
        {
            switch (this.Type) {
                ...
                case ArmadaUpgradeType.UnlockNewShip:
                    buffer.Add(this.RelatedShip.Description).SkipLine();
                    buffer.Add("This upgrade will grant the ability to build ").Add( this.CapIncrease, "ffa1a1" ).Add(" additional ").Add(this.ShipForCapIncrease.GetDisplayName() ).Add(" at any stronghold. The flagship of that stronghold will then be able to build ").Add(this.RelatedShip.GetDisplayName(), "a1ffa1").Add(" at any armada shipyard.\n");
                    break;
                default:
