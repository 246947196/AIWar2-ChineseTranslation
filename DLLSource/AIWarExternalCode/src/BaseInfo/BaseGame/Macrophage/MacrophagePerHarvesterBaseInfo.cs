...
{
    public class MacrophagePerHarvesterBaseInfo : ExternalSquadBaseInfo
    {
        ...
        public MacrophagePerHarvesterBaseInfo()
        {
            Cleanup();
        }
        ...
        public override void CopyTo( ExternalSquadBaseInfo CopyTarget )
        {
            if ( CopyTarget == null )
                return;
            MacrophagePerHarvesterBaseInfo target = CopyTarget as MacrophagePerHarvesterBaseInfo;
            if ( target == null )
            {
