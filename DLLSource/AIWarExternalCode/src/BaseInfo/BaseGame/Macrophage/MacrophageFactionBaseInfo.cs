...
{
    public class MacrophageFactionBaseInfo : MacrophageFactionBaseInfoCore
    {
        //serialized
        ...
        public static List<MacrophageFactionBaseInfo> AllRegularMacrophageFactions = List<MacrophageFactionBaseInfo>.Create_WillNeverBeGCed( 8, "MacrophageFactionBaseInfo-AllRegularMacrophageFactions" );
        public int Intensity = 0;

        //constants        

        public MacrophageFactionBaseInfo()
        {
            Cleanup();
        }
        ...
        {
            //not serialized
            AllRegularMacrophageFactions.Clear();
        }
        ...
        {
            if ( !AllRegularMacrophageFactions.Contains( this ) )
                AllRegularMacrophageFactions.Add( this );
        }
        #endregion
