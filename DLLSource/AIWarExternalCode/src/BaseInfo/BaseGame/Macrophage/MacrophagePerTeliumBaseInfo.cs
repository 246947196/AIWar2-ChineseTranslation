...
{
    public class MacrophagePerTeliumBaseInfo : ExternalSquadBaseInfo
    {
        ...
        public MacrophagePerTeliumBaseInfo()
        {
            Cleanup();
        }
        ...
        public override void CopyTo( ExternalSquadBaseInfo CopyTarget )
        {
            if ( CopyTarget == null )
                return;
            MacrophagePerTeliumBaseInfo target = CopyTarget as MacrophagePerTeliumBaseInfo;
            if ( target == null )
            {
