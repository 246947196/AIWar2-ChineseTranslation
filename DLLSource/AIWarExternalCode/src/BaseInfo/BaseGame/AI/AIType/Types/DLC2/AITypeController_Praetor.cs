...
{
    public class AITypeController_Praetor : BaseAITypeImplementation
    {
        public override void AllocateSpendingRatios_AnySituation( Faction faction, EnumIndexedArray<AIBudgetType, FInt> aipToQuasiAllocate, FInt aip )
        {
            ...
            EnumIndexedArray<AIBudgetType, FInt> aipRatioForStep = AIBudgetItem.GetTemporaryBudgetRatioArray( "AITypeController_Praetor-AllocateSpendingRatios_AnySituation-aipRatioForStep", 10f );
            ...
            aipRatioForStep[AIBudgetType.Wave] = FInt.FromParts( 0, 225 );
            aipRatioForStep[AIBudgetType.BorderAggression] = FInt.FromParts( 0, 050 );
            ...
            aipRatioForStep[AIBudgetType.PraetorianGuard] = FInt.FromParts( 0, 230 );
            ...
            aipRatioForStep[AIBudgetType.Wave] = FInt.FromParts( 0, 375 );
