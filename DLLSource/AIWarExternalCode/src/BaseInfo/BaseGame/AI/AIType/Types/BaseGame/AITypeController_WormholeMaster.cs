...
{
    public class AITypeController_WormholeMaster : BaseAITypeImplementation
    {
        public override void AllocateSpendingRatios_AnySituation( Faction faction, EnumIndexedArray<AIBudgetType, FInt> aipToQuasiAllocate, FInt aip )
        {
            ...
            EnumIndexedArray<AIBudgetType, FInt> aipRatioForStep = AIBudgetItem.GetTemporaryBudgetRatioArray( "AITypeController_WormholeMaster-AllocateSpendingRatios_AnySituation-aipRatioForStep", 10f );
            ...
            aipRatioForStep[AIBudgetType.PraetorianGuard] = FInt.FromParts( 0, 200 );
            ...
            aipRatioForStep[AIBudgetType.Reconquest] = FInt.FromParts( 0, 125 );
            aipRatioForStep[AIBudgetType.WormholeInvasion] = FInt.FromParts( 0, 200 );
            ...
            aipRatioForStep[AIBudgetType.Reconquest] = FInt.FromParts( 0, 125 );
            aipRatioForStep[AIBudgetType.WormholeInvasion] = FInt.FromParts( 0, 300 );
            AllocateAIPWithinStep( aipToQuasiAllocate, aipRatioForStep, bottomOfStep, topOfStep, aip );
