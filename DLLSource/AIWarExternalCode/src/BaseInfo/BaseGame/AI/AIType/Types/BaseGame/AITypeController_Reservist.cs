...
{
    public class AITypeController_Reservist : BaseAITypeImplementation
    {
        public override void AllocateSpendingRatios_AnySituation( Faction faction, EnumIndexedArray<AIBudgetType, FInt> aipToQuasiAllocate, FInt aip )
        {
            ...
            EnumIndexedArray<AIBudgetType, FInt> aipRatioForStep = AIBudgetItem.GetTemporaryBudgetRatioArray( "AITypeController_Reservist-AllocateSpendingRatios_AnySituation-aipRatioForStep", 10f );
            ...
            aipRatioForStep[AIBudgetType.Reinforcement] = FInt.FromParts( 0, 125 );
            aipRatioForStep[AIBudgetType.CPA] = FInt.FromParts( 0, 350 );
