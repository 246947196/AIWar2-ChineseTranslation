...
namespace Arcen.AIW2.External
{
    ...
    public abstract class AISubFactionCoreDataRoot : AICoreDataRoot
    {
        ...
        {
            Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.CurrentTargetPlanetIndex, "CurrentTargetPlanetIndex" );
        ...
        public void DeserializeInto( SerMetaData MetaData, ArcenDeserializationBuffer Buffer, SerializationCommandType SerializationCmdType )
        {
            ...
            Interlocked.Exchange( ref this.CurrentTargetPlanetIndex, Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "CurrentTargetPlanetIndex" ) );
