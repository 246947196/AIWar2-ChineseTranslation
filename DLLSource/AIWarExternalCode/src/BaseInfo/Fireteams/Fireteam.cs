    ...
    public class Fireteam : FireteamBase, ArcenLessLinkedList<Fireteam>.IContainable, ITimeBasedPoolable<Fireteam>, IProtectedListable
    {
        ...
        public void SerializeTo( SerMetaData MetaData, ArcenSerializationBuffer Buffer, SerializationCommandType SerializationCmdType )
        {
            ...
            try
            {
                ...
                Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.TargetPlanet == null ? -1 : this.TargetPlanet.Index, "TargetPlanet" );
                ...
                Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.LurkPlanet == null ? -1 : this.LurkPlanet.Index, "LurkPlanet" );
        ...
        public void DeserializedIntoSelf( SerMetaData MetaData, int FireTeamID, ArcenDeserializationBuffer Buffer, SerializationCommandType SerializationCmdType, string ForDebugging_FactionName )
        {
            ...
            this.TargetPlanet = World_AIW2.Instance.GetPlanetByIndex( (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "TargetPlanet" ) );
            ...
            this.LurkPlanet = World_AIW2.Instance.GetPlanetByIndex( (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "LurkPlanet" ) );
        ...
        public class HistoryItem : ConcurrentPoolable<HistoryItem>, IProtectedListable
        {
            ...
            public void SerializeTo( SerMetaData MetaData, ArcenSerializationBuffer Buffer, SerializationCommandType SerializationCmdType )
            {
                ...
                switch ( this.Type )
                {
                    ...
                    case HistoryItemType.SuicideAttack:
                        Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.PlanetIndex1, "HistoryItem-PlanetIndex1" );
                        break;
                    ...
                    case HistoryItemType.LeaveToHelpAllies:
                        Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.PlanetIndex1, "HistoryItem-PlanetIndex1" );
                        Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.PlanetIndex2, "HistoryItem-PlanetIndex2" );
                        break;
                    case HistoryItemType.StagingToLurkPlanet:
                        Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.PlanetIndex1, "HistoryItem-PlanetIndex1" );
                        Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.PlanetIndex2, "HistoryItem-PlanetIndex2" );
                        Buffer.AddIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, this.PlanetIndex3, "HistoryItem-PlanetIndex3" );
                        break;
            ...
            public static HistoryItem DeserializeFrom_NewStyle( SerMetaData MetaData, ArcenDeserializationBuffer Buffer, SerializationCommandType SerializationCmdType )
            {
                ...
                switch ( result.Type )
                {
                    ...
                    case HistoryItemType.DefensiveFleetWaitingInGeneral:
                    case HistoryItemType.SuicideAttack:
                        result.PlanetIndex1 = (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "HistoryItem-PlanetIndex1" );
                        break;
                    case HistoryItemType.RetreatFromLurkLocation:
                    case HistoryItemType.RetreatFromTravelToLurkLocation:
                    case HistoryItemType.LurkingAgainstAnotherPlanet:
                    ...
                    case HistoryItemType.LeaveToHelpAllies:
                        result.PlanetIndex1 = (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "HistoryItem-PlanetIndex1" );
                        result.PlanetIndex2 = (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "HistoryItem-PlanetIndex2" );
                        break;
                    case HistoryItemType.StagingToLurkPlanet:
                        result.PlanetIndex1 = (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "HistoryItem-PlanetIndex1" );
                        result.PlanetIndex2 = (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "HistoryItem-PlanetIndex2" );
                        result.PlanetIndex3 = (Int16)Buffer.ReadIntUltraEfficient( MetaData, UltraEfficientStyle.G_ˉ1_To_511, "HistoryItem-PlanetIndex3" );
                        break;
                    case HistoryItemType.EscortShip:
