...
{
    public class FallenSpirePerUnitBaseInfo : ExternalSquadBaseInfo
    {
        //serialized
        ...
        public FallenSpirePerUnitBaseInfo()
        {
            Cleanup();
        }
        ...
        public override void CopyTo( ExternalSquadBaseInfo CopyTarget )
        {
            if ( CopyTarget == null )
                return;
            FallenSpirePerUnitBaseInfo target = CopyTarget as FallenSpirePerUnitBaseInfo;
            if ( target == null )
            {
