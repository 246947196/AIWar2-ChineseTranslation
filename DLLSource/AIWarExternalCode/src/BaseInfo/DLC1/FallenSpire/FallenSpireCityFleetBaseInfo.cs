...
{
    public class FallenSpireCityFleetBaseInfo : ExternalFleetBaseInfo, IBolsteringFleet
    {
        ...
        public List<SafeSquadWrapper> FleetsThatCanBeBolstered {
            get {
                return FallenSpireFactionBaseInfo.Instance.SpirePlayerFleets.GetDisplayList();
            }
        }
        ...
        {
            bool ExpertMode = FallenSpireFactionBaseInfo.Instance.ExpertMode;
            CityManager.RecalculateCityBuildingContents(this.AttachedFleet, "SpireCityBuildMenu", delegate (GameEntity_Squad city, GameEntityTypeData buildingInfo) {
