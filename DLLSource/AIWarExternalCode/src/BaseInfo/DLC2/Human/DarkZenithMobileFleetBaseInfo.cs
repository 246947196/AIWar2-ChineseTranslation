...
{
    public class DarkZenithMobileFleetBaseInfo : FleetMetricsBaseInfo
    {
        public DarkZenithMobileFleetBaseInfo() { Cleanup(); }

        protected override void Cleanup() { base.Cleanup(); }

        public override void SerializeTo( SerMetaData MetaData, ArcenSerializationBuffer Buffer, SerializationCommandType SerializationCmdType )
        {
            Buffer.WriteHeaderStringToLogIfLoggingActive( "DarkZenithMobileFleetBaseInfo" );
        ...
        {
            Buffer.WriteHeaderStringToLogIfLoggingActive( "DarkZenithMobileFleetBaseInfo" );
            Buffer.ActivateOrAddTrackerByNameIfTracking( "DarkZenithMobileFleetBaseInfo Ext", TrackerStyle.ByTypeOnly );
