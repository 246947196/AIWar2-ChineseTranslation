...
{
    public class Window_InGameSidebarTips : Window_InGameSidebarBase
    {
        public int GetCountOfNewTips()
        {
            int newEntryCount = 0;
        ...
        public static Window_InGameSidebarTips Instance;
        public Window_InGameSidebarTips()
        {
            Instance = this;
        ...
        {
            return Current == InGameSidebarType.Tips;
        }
        ...
        public class customParent : CustomUIAbstractBase
        {
            public customParent()
            {
                Window_InGameSidebarTips.CustomParentInstance = this;
            }
            ...
            public override void OnUpdate()
            {
                ...
                if ( Window_InGameSidebarTips.Instance != null )
                {
                    #region Global Init
        ...
        public class btnJournalItem : ButtonAbstractBase
        {
            ...
            public override void GetTextToShowFromVolatile( ArcenDoubleCharacterBuffer buffer )
            {
                ...
                {
                    buffer.Add( "<size=140%>" ).Add( entry.DoLocalTextReplacements( this.CampaignEntry, entry.SidebarText ) );
                    //if ( this.TimeText )
            ...
            public override void HandleMouseover()
            {
                ...
                if ( entry == null )
                    return;
                Window_AtMouseTooltipPanelBesideSidebar.bPanel.Instance.SetText( "左键查看详情。右键可将视角居中到本提示讨论的目标（如果存在）。", "GeneralTooltipScale" );
            }
        }
        #endregion
        ...
        public class tHeaderText : TextAbstractBase
        {
            public override void GetTextToShowFromVolatile( ArcenDoubleCharacterBuffer Buffer )
            {
                int newCount = Instance.GetCountOfNewTips();
                if ( newCount > 0 )
                    Buffer.Add( "提示 (<color=#ffba36>" ).Add( newCount ).Add( " 新</color>)" );
                else
                    Buffer.Add( "提示" );
            }
        }
