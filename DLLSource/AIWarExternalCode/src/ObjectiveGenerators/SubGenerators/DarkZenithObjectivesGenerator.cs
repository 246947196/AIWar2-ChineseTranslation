...
namespace Arcen.AIW2.External
{
    ...
    public class DZFleetMenu : IObjectiveHookManager
    {
        ...
        public void TooltipHandler( ArcenDoubleCharacterBuffer buffer, ActualObjective Objective )
        {
            ...
            buffer.Add( "  鈥?", ObjectiveColors.Hint ).Add( "分配每个柱楣建造什么", "55aaff" ).Add( "：单位、Terminii、建筑或升级。\n" );
    ...
    public class DZEconomy : IObjectiveHookManager
    {
        ...
        public void TooltipHandler( ArcenDoubleCharacterBuffer buffer, ActualObjective Objective )
        {
            ...
            buffer.Add( "柱楣", "55aaff" ).Add( "是你的工厂。它们将存储的资源转换为单位、新的Terminii和其他建筑。" );
            ...
            buffer.Add( "私掠者", "55aaff" ).Add( "会偷取你的其他运输船供给海盗柱楣，后者生产超强力的单位。", ObjectiveColors.Hint );
        }
    }
    ...
    public class DZTechTree : IObjectiveHookManager
    {
        ...
        public void TooltipHandler( ArcenDoubleCharacterBuffer buffer, ActualObjective Objective )
        {
            buffer.Add( "黑暗 Zenith科技树由", ObjectiveColors.Hint ).Add( "变体升级", "55aaff" ).Add( "驱动（解锁每个单位层级的特殊灌注形态）。\n\n" );
            ...
            buffer.Add( "等级", ObjectiveColors.Hint ).Add( "解锁所有单位的更强版本：\n" );
    ...
    public class DZShipVariants : IObjectiveHookManager
    {
        ...
        public void TooltipHandler( ArcenDoubleCharacterBuffer buffer, ActualObjective Objective )
        {
            buffer.Add( "黑暗 Zenith单位可以用次级资源灌注以创造具有特殊能力的", ObjectiveColors.Hint ).Add( "变体形态", "55aaff" ).Add( "。每个层级有五种变体：\n\n" );
            ...
            buffer.Add( "变体必须为每个单位层级分别解锁，并从上一层级同类型变体链式解锁。" );
    ...
    public class DZFimbulwinter : IObjectiveHookManager
    {
        ...
        public void TooltipHandler( ArcenDoubleCharacterBuffer buffer, ActualObjective Objective )
        {
            ...
            buffer.Add( "  鈥?", ObjectiveColors.Hint ).Add( "黑暗 Zenith及盟友单位", "55aaff" ).Add( "在星球上移动更快。\n" );
            buffer.Add( "  鈥?", ObjectiveColors.Hint ).Add( "敌方单位", "ff8877" ).Add( "进入星球时速度减慢。\n\n" );
    ...
    public class DZNadir : IObjectiveHookManager
    {
        ...
        public void TooltipHandler( ArcenDoubleCharacterBuffer buffer, ActualObjective Objective )
        {
            ...
            buffer.Add( "天底基地", "ff8877" ).Add( "是AI部署的专门用于对抗黑暗 Zenith的建筑。它们不断生成反DZ单位以消耗你的力量和经济。\n\n" );
            buffer.Add( "摧毁天底基地：\n" );
